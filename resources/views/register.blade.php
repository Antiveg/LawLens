...
<head>
    ...
    <title>LawLens | Register</title>
</head>
<body>
    <section class="bg-white dark:bg-gray-900">
        <div class="flex justify-center min-h-screen">
            <div class="hidden bg-cover lg:block lg:w-2/5" style="background-image: url('/assets/service/tata-niaga.png')">
            </div>
    
            <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                <div class="w-full">
                    <h1 class="text-2xl font-semibold tracking-wider text-gray-800 capitalize dark:text-white">
                        Get Your LawLens Account Now
                    </h1>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-3 md:flex md:items-center md:-mx-2">
                            <button class="flex justify-center w-full px-6 py-3 text-white bg-yellow-400 rounded-lg md:w-auto md:mx-2 focus:outline-none">
                            ...
                            <button class="flex justify-center w-full px-6 py-3 mt-4 text-yellow-500 border border-yellow-500 rounded-lg md:mt-0 md:w-auto md:mx-2 dark:border-yellow-400 dark:text-yellow-400 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" action="/login">
                        <div>
                        ...
                        <button
                            class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-yellow-400 rounded-lg hover:bg-yellow-500 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-50">
                            <span>Sign Up </span>
                    ...
                    <p class="mt-6 text-sm text-left text-gray-400">Already have an account yet? <a href="/login" class="text-yellow-500 focus:outline-none focus:underline hover:underline">Login</a>.</p>
                </div>
            </div>
        </div>
    </section>
