...
<footer class="bg-zinc-900 dark:bg-gray-900">
    ...
    <div class="px-4 py-6  dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">LawLens™</a>. All Rights Reserved.
        </span>
