        ...
        <div class="xl:items-center xl:-mx-8 xl:flex">
            ...
            <div class="flex-1 xl:mx-8">
                <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                    <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-white">
                        <div class="p-6">
                            <h1 class="text-xl font-medium text-white capitalize lg:text-2xl dark:text-white">Essential</h1>

                            <p class="mt-4 text-white dark:text-gray-300">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus
                            </p>

                            <h2 class="mt-4 text-2xl font-semibold text-white sm:text-3xl dark:text-gray-300">$3.00 <span class="text-base font-medium">/Month</span></h2>

                            <p class="mt-1 text-white dark:text-gray-300">
                                Yearly payment
                            </p>
                        ...
                        <div class="p-6">
                            <h1 class="text-lg font-medium text-white capitalize lg:text-xl dark:text-white">What’s included:</h1>
                            ...
                            <div class="mt-8 space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">All limited links</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">Own analytics platform</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">Chat support</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">Optimize hashtags</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">Mobile app</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-4 text-white dark:text-gray-300">Unlimited users</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-white">
                        <div class="p-6">
                            ...
                            <h2 class="mt-4 text-2xl font-semibold text-white sm:text-3xl dark:text-gray-300">$50.00 <span class="text-base font-medium">/life time</span></h2>
